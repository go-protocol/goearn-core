...
const BASE_TEN = 10;
const thisStrategy = "StrategyGolf";
...
describe("测试" + thisStrategy, function () {
    ...
    for (let i = 0; i < tokenJson[thisStrategy].length; i++) {
        it("部署策略", async function () {
            ...
            vault = tokenJson[thisStrategy][i].vault;
        ...
        it("balanceOfWant", async function () {
            ...
            console.log(
                "   balanceOfWant:",
                ethers.utils.formatEther(balanceOfWant).toString()
            );
        });
        ...
        it("balanceOfVault", async function () {
            ...
            console.log(
                "   balanceOfVault:",
                ethers.utils.formatEther(balanceOfVault).toString()
            );
        });
        ...
        it("balanceOfPool", async function () {
            ...
            console.log(
                "   balanceOfPool:",
                ethers.utils.formatEther(balanceOfPool).toString()
            );
        });
